Ext.onReady(function(){
    ...
    var selectCorpId;
	var type;
	fields= ['id','recv_time','gps_time','longitude','latitude','name','login_name','memo','status','corp_id','pdt_id'];
	...
	window.show_map = show_map;
     ...
     show_win = function(id){
    	 ...
    	 var new_win = new Ext.Window({
    		 ...
    		 autoWidth:true,
    		 autoHeight:true,
    		 html:'<span style="display:table;width:100%;"><span><img src="/uploaded/visitator/defect/'+id+'.jpg"/></span></span>'
    	 })
