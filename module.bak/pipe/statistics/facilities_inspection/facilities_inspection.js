...
//         store.load({params:{start:0,limit:Ext.zion.page.limit,terminal_status:16}});
         ...
         show_win = function(id){
        	 var panel = new Ext.Panel({
        		 height:200,
            	 width:200,
            	 html:'<span><img width=300 height=300 src="/uploaded/visitator/facilities/'+id+'.jpg"/></span>'
        	 })
        	 var new_win = new Ext.Window({
        		 ...
        		 autoWidth:true,
        		 autoHeight:true,
        		 html:'<span style="display:table;width:100%;"><img src="/uploaded/visitator/facilities/'+id+'.jpg"/></span>'
        	 })
