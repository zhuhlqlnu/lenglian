...
function drawtrackpoint(position) {
	...
	if (!currentGMarker) {
		...
		targetIcon.image = "images/car.png";
		var markerOptions = {
			icon : targetIcon,
			clickable : true
		}
...
function trackDataObj(gps_time, recv_time, longitude, latitude, speed, heading, status, terminal_status_desc, terminal_status, track_id, temp_0, temp_bat_0, temp_id_0, temp_1, temp_bat_1, temp_id_1) {
...
function parseTrackData(data) {
	...
	for ( var i = 0; i < data.length; i++) {
		...
		var tmptrackDataObj = new trackDataObj(gps_time, recv_time, longitude, latitude, speed, heading, status, terminal_status_desc, terminal_status, track_id, temp_0, temp_bat_0, temp_id_0,
