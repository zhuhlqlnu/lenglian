...
Ext.onReady(function() {
	...
	var form = new Ext.form.FormPanel({
		...
		buttonAlign:'center',
		items: [
			{fieldLabel: '开始时间',allowBlank :false,editable:false,id: 'startdttrack', width: 115, format:'Y-m-d', xtype: 'datefield',value: new Date() }
	    	,{ xtype: 'timefield', allowBlank :false, editable:false, format :'H:i', id: 'starttftrack', width: 115, increment: 1,value: '08:00'}
	    	,{fieldLabel: '结束时间',allowBlank :false,editable:false, id: 'enddttrack',width: 115, format:'Y-m-d',xtype: 'datefield',value: new Date()}
	    	,{ xtype: 'timefield',allowBlank :false,editable:false,format :'H:i', id: 'endtftrack', width: 115, increment: 1,value: '18:00'}
		],
		buttons : [{
			text: '查询',
			handler:function(){
				...
				//Zion.track.getTrack(91, std.getTime() / 1000 , end.getTime() / 1000 , function(data) {
	...
	var card2 = new Ext.Panel({
    	width: 300,
		layout: 'fit',
		items: [{xtype: 'form',bodyStyle:'padding:5px 10px 0',width: 300,labelWidth:100,
			items: [{
				xtype: 'radiogroup',
				hideLabel: true,
				items: [{boxLabel: '锁定', name: 'roadcorrect', inputValue: 1,handler :function(){if(this.checked){mapViewModal = true;}}},
				        {boxLabel: '自由视野', name: 'roadcorrect', inputValue: 2, checked: true,handler :function(){if(this.checked){mapViewModal = false;}}}
				]
			...
			},new Ext.Slider({id:'playspeedslider', width: 214,increment: 1,minValue: 1,maxValue: 4,
				...
				items: [new Ext.Button({id:'media_controls_first',iconCls: 'light_first',value:'0',
					handler:function(){
						resetimgsrc();
				...
				}),new Ext.Button({id:'media_controls_play',iconCls: 'light_play',
					handler:function(){
						resetimgsrc();
				...
				}),new Ext.Button({id:'media_controls_pause',iconCls: 'light_pause',
					handler:function(){
						resetimgsrc();
				...
				}),new Ext.Button({id:'media_controls_stop',iconCls: 'light_stop',
					handler:function(){
						resetimgsrc();
				...
				}),new Ext.Button({id:'media_controls_last',iconCls: 'light_last',
					handler:function(){
						resetimgsrc();
